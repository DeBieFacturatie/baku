...
import lassen from "../assets/lassen.png";
        ...
        >
          <div className="flex lg:flex-1">
            <a href="#" className="-m-1.5 p-1.5">
              ...
              <img alt="" src={headerimage} className="h-9 w-auto" />
            </a>
          </div>
                ...
                <div className="relative w-full lg:max-w-xl lg:shrink-0 xl:max-w-2xl">
                  ...
                  <div className="mt-10 flex items-center gap-x-6">
                    <a
                      ...
                      className="rounded-md bg-bakublue px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-bakubluehover focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-bakublue"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 256 256"
                        fill="currentColor"
                        className="inline-block h-5 w-5 -mt-0.5 mr-1.5"
                      >
