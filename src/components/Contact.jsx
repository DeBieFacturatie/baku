...
import logoWit from "../assets/logo-wit.svg";
          ...
          <div className="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
            <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
              ...
              <p className="mt-6 text-base text-gray-600">
                We staan klaar om uw vragen, ideeën of verzoeken te
                beantwoorden. Laat van u horen!
              </p>
              <dl className="mt-10 space-y-4 text-base text-gray-600">
                ...
                <div className="flex gap-x-4">
                  ...
                  <dd>
                    <a
                      href="mailto:info@bakumetaal.nl"
          ...
          <div className="py-16 lg:col-span-2 lg:py-24 xl:pr-12 px-6 sm:px-0">
            <div className="mx-auto max-w-lg">
              ...
              <p className="mt-3 text-base text-gray-900 font-light">
                ...
                klaar om al uw vragen te beantwoorden en u verder te helpen met
                uw project.
              </p>
